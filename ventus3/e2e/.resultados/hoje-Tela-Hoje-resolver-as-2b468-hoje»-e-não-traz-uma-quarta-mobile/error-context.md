...
- Name: hoje.spec.ts >> Tela Hoje >> resolver as 3 dá «Pronto por hoje» e não traz uma quarta
- Location: e2e/hoje.spec.ts:89:3
...
Call log:
  - waiting for getByRole('button', { name: 'Desfazer' }) to be visible
    6 × waiting for "http://127.0.0.1:5288/" navigation to finish...
      - navigated to "http://127.0.0.1:5288/"
