...
- Name: hoje.spec.ts >> Tela Hoje >> carteira vazia não se confunde com dia tranquilo
- Location: e2e/hoje.spec.ts:122:3
...
Locator: getByText('Baixando a sua carteira')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText('Baixando a sua carteira')
